  ...
  return (
    <section className="relative flex h-full w-full items-center justify-center ">
      ...
      >
        <motion.div
          style={{ x, y, opacity }}
          className="relative z-20 flex w-fit select-none items-center justify-center gap-2 p-2 pt-0 text-sm text-white mix-blend-exclusion"
        >
  ...
  return (
    <div className="fixed left-0 top-0 z-[101] flex h-screen w-screen items-center justify-center">
      ...
      <motion.div
        ...
        className="relative aspect-video max-w-6xl"
      >
