-- Temporarily disable RLS for testing the people finder
-- This allows us to test the application without authentication restrictions

-- Disable RLS on users table
ALTER TABLE users DISABLE ROW LEVEL SECURITY;

-- Disable RLS on personal_details table  
ALTER TABLE personal_details DISABLE ROW LEVEL SECURITY;

-- Disable RLS on technical_profiles table
ALTER TABLE technical_profiles DISABLE ROW LEVEL SECURITY;

-- Also remove the foreign key constraint temporarily to allow our test data
ALTER TABLE users DROP CONSTRAINT IF EXISTS users_id_fkey;

-- Re-insert our test data if it doesn't exist
...
-- Insert corresponding personal details
...
-- Insert corresponding technical profiles  
